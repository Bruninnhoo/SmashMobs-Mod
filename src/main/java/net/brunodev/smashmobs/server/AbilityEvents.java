...
public class AbilityEvents {
    ...
    public static void startAirStrike(Player player) {
        ...
        // Spawn highly above
        net.minecraft.world.phys.Vec3 startPos = player.position().add(0, 30, 0).subtract(player.getLookAngle().scale(20.0));
        ...
        net.brunodev.smashmobs.entity.AirstrikeJetEntity jet = new net.brunodev.smashmobs.entity.AirstrikeJetEntity(net.brunodev.smashmobs.SmashMobs.AIRSTRIKE_JET.get(), level);
        jet.setPos(startPos);
        jet.setOwner(player);
    ...
    public static void spawnSentryGun(Player player) {
        Level level = player.level();
        net.brunodev.smashmobs.entity.SentryGunEntity sentry = new net.brunodev.smashmobs.entity.SentryGunEntity(net.brunodev.smashmobs.SmashMobs.SENTRY_GUN.get(), level);
    ...
    public static void shootPredatorMissile(Player player) {
        ...
        net.minecraft.world.phys.HitResult hr = player.pick(60.0, 0.0F, false);
        net.minecraft.world.phys.Vec3 targetPos = hr.getLocation();
        
        // Spawn high above target
        net.minecraft.world.phys.Vec3 spawnPos = targetPos.add(0, 35, 0);
        
        net.brunodev.smashmobs.entity.PredatorMissileEntity missile = new net.brunodev.smashmobs.entity.PredatorMissileEntity(net.brunodev.smashmobs.SmashMobs.PREDATOR_MISSILE.get(), level);
